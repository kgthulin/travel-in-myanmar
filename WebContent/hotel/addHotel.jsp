...
<body>
	<div class="container">
		<form id="contact" action="AddHotelAction" method="post">
			<h3 align="center">Add New Hotel</h3>
			<fieldset>
				<label for="name">Name</label> <input type="text" name="name"
					tabindex="1" pattern="[A-Za-z ]{1,32}" required autofocus>
			</fieldset>
			<fieldset>
			...
			<fieldset>
				<label for="rating">Rating</label> <input type="text" name="rating"
					tabindex="4" id="rating" pattern="[0-9]+.[0-9]+" title="Cannot contain characters." required>
			</fieldset>
			<fieldset>
