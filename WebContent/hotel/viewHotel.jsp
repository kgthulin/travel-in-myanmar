		...
		<div class="row">
			<div class="col-md-12">
				<div style="margin-bottom: 10px; text-align: right;">
					<s:url id="loc" action="setUpForHotelLocation" />
					<s:a href="%{loc}" cssClass="btn btn-info btn-md" tabindex="-1"
							role="button" aria-disabled="true">Create New Hotel</s:a>
				</div>
			</div>
		</div>
		<div class="row">
				...
				<div style="background-color: #5eb2b3">
					<ul class="nav flex-column">
						...
						<li class="nav-item"><s:url id="viewHotel"
								action="ViewHotelAction" /> <s:a cssClass="nav-link active"
			...
			<div class="col-md-10">
				<table class="table table-hover" style="background: #adebeb">
					...
					<tbody>
						<s:iterator value="hotelList" status="status">
							<tr>
								...
								<td><s:url id="update" action="setUpForHotelUpdate">
										<s:param name="currentId" value="hotel_id" />
									</s:url> <s:a href="%{update}" cssClass="btn btn-info btn-sm"
										role="button" aria-disabled="true">Edit</s:a></td>
								<td><s:url id="delete" action="DeleteHotelAction">
										<s:param name="currentId" value="hotel_id" />
