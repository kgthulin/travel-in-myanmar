		...
		<div class="row">
			<div class="col-md-12">
				<div style="margin-bottom: 10px; text-align: right;">
					<a href="${pageContext.request.contextPath}/location/addLocation.jsp"
						class="btn btn-info btn-md" tabindex="-1" role="button"
						aria-disabled="true">Create New Location</a>
				</div>
			</div>
		</div>
		<div class="row">
				...
				<div style="background-color: #5eb2b3">
					<ul class="nav flex-column">
						...
						<li class="nav-item"><s:url id="viewLoc"
								action="ViewLocationAction" /> <s:a cssClass="nav-link active"
			...
			<div class="col-md-10">
				<table class="table table-hover" style="background: #adebeb">
					...
					<tbody>
						<s:iterator value="locationList" status="status">
							<tr>
								<th scope="row"><s:property value="#status.count" /></th>
								<td><s:property value="name" /></td>
								<td><s:property value="mile" /></td>
<%-- 								<td><s:url id="update" action="setUpForLocationUpdate">
										<s:param name="currentId" value="location_id" />
									</s:url> <s:a href="%{update}" cssClass="btn btn-info btn-sm"
										role="button" aria-disabled="true">Edit</s:a></td> --%>
								<td><s:url id="delete" action="DeleteLocationAction">
										<s:param name="currentId" value="location_id" />
